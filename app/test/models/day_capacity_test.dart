...
void main() {
  group('computeDayCapacity', () {
    ...
    test('planning past the window reports overplanned, not negative available', () {
      final day = computeDayCapacity(
        date: DateTime(2026, 8, 17),
        plannedHours: 13,
        actualHours: 0,
    ...
    test('defaults to the 07:00–18:00 window used elsewhere for "untracked"', () {
      final day = computeDayCapacity(date: DateTime(2026, 8, 17), plannedHours: 0, actualHours: 0);
